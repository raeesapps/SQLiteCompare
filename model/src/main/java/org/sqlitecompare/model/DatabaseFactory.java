...
public final class DatabaseFactory {
  ...
  public static Database createDatabase(final String databaseYaml)
        ...
        for (var currentType : objectLists.keySet()) {
          ...
          for (var currentObject : objectsOfCurrentType) {
            ...
            for (var dependencyObject : dependencies) {
              ...
              deserialisedObjectBuilder.dependency(new Dependency(
                  DependencyType.valueOf((String) dependencyMap.get("dependencyType")),
                  (String) dependencyMap.get("nameOfConsumedObject")));
            }
